        ...
        >
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="preciobase" class="text-right">{{
                formatearNumero(props.row.preciobase)
              }}</q-td>
              ...
              <q-td key="importe" class="text-right">{{ formatearNumero(props.row.importe) }}</q-td>
              <q-td key="descuento" class="text-right">{{ props.row.descuento }}</q-td>
              <q-td key="totalcosto" class="text-right">{{
                formatearNumero(props.row.totalcosto)
              }}</q-td>
              <q-td key="totalventa" class="text-right">{{
                formatearNumero(props.row.totalventa)
              }}</q-td>
              <q-td key="utilidad" class="text-right">{{
                formatearNumero(props.row.utilidad)
              }}</q-td>
